...
cornerItems.append(helpButton,settingsButton,sourceButton);
...
document.addEventListener('change',changed,true);document.addEventListener('input',()=>{updateCurrent();render();changed();},true);
