    ...
    def display_settings(self, payload=None):
        ...
        with self.display_lock:
            ...
            if payload is not None:
                ...
                if 'theme' in payload:
                    if payload['theme'] not in ('classic', 'glass', 'glass-dusk', 'glass-moon', 'glass-atelier'): raise ApiError('请选择经典主题或液态玻璃。')
            ...
            return {'glassMaterial': 'frosted' if saved.get('glassMaterial') == 'frosted' else 'liquid', 'idCheckExcludedProjects': saved.get('idCheckExcludedProjects', []), 'theme': saved.get('theme') if saved.get('theme') in ('classic', 'glass', 'glass-dusk', 'glass-moon', 'glass-atelier') else 'glass', 'showRecordIds': saved.get('showRecordIds') is not False, 'autoSave': saved.get('autoSave') is True, 'workshopFavorites': favorites, 'saveOnExit': saved.get('saveOnExit', saved.get('autoSave',False)) is True, 'onboardingComplete': saved.get('onboardingComplete') is True}
...
class StudioHandler(BaseHTTPRequestHandler):
    ...
    def dispatch(self, method):
        ...
        if method == "GET":
            ...
            if route in ("/plugin-mode.js", "/plugin-mode.css", "/editor-music.js", "/editor-music.css", "/character-images.js", "/external-dialogues.js", "/external-uses.js", "/app-updates.js", "/original-mode.js", "/event-ownership.js", "/indexed-talks.js", "/remote-talks.js", "/live-preview.js", "/config-doctor.js", "/save-review.js", "/libraries.js", "/json-editor.js", "/json-editor.css", "/editor-theme.css", "/glass-palette.css", "/glass-theme.css", "/liquid-glass.js", "/theme.js", "/glass-tones.css", "/frosted-glass.css", "/home-feedback.css", "/atelier.css", "/atelier-tones.css", "/onboarding.js", "/onboarding.css", "/brand.svg", "/branch-tree.js", "/idle-chats.js", "/idle-chats.css", "/message-graph.js", "/messages.js", "/messages.css", "/goals.js", "/goals.css", "/character-ui.js", "/characters.js", "/character-model.js", "/character-states.js", "/character-model.css", "/character-controls.js", "/space-style.js", "/space-style.css", "/minigame-sudoku.js", "/minigame-library.js", "/minigame-library.css", "/characters.css", "/event-types.js", "/record-labels.js", "/record-labels.css", "/search-pinyin.js", "/search.js", "/record-ids.js", "/record-ids.css", "/navigation.js", "/navigation.css", "/help.js", "/app.js", "/scene.js", "/screen-effects.js", "/screen-effects.css", "/branches.js", "/timeline.js", "/conditions.js", "/condition-library.js", "/effects.js", "/history.js", "/dialogue-text.js", "/dialogue-selection.js", "/dialogue-selection.css", "/action-editor.js", "/performance.css", "/preview-ui.js", "/preview-text.js", "/preview-ui.css", "/locations.js", "/event-bindings.js", "/warehouse.js", "/warehouse.css", "/workshop.js", "/workshop.css", "/workshop-publish-ui.js", "/workshop-publish.css", "/social-media.js", "/social.js", "/social.css", "/space.js", "/reuse-assets.js", "/reuse-assets.css", "/events.js", "/events.css", "/asset-picker.js", "/asset-picker.css", "/ui-controls.js", "/ui-controls.css", "/scene-dialogue.css", "/asset-names.js", "/expressions.js", "/styles.css", "/icon.png"):
