...
if(scanTimer){clearTimeout(scanTimer);scanTimer=0;}discover();if(raf){cancelAnimationFrame(raf);raf=0;}if(enabled()&&!document.hidden&&!opaque.matches&&!lost)draw();}
